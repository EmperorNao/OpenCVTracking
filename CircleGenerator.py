...
def show_with_contours_and_tracking(path, tracker,
                                    show=True,
                                    track=True,
                                    log=False,
                                    blacked=False,
...
show_with_contours_and_tracking(path, tracker, n_vectors=24, sleep=0, vectors=True, track=True, show=True, track_log=True)